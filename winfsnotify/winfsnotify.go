...
// Note: This is a modified version of the package that
// adds the AddDeepWatch() and DeepWatch() functions
// for enabling events deep within a watched tree.  It
// will be replaced with the official package if these
// improvements are ever incorported.
